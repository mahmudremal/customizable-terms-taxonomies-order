...
function autoloader($resource = '') {
	...
	if ('inc' === $path[0]) {
		...
		$resource_path = sprintf('%s/inc/%s/%s.php', untrailingslashit(CTTO_DIR_PATH), $directory, $file_name);
...
spl_autoload_register('\CTTO\inc\Helpers\autoloader');
